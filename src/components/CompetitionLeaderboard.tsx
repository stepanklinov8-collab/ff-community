...
interface Entry {id: string; name: string; avatar_url: string | null; position: number; rating: number; wins: number; games: number; kills: number; cost?: number; series: number}
